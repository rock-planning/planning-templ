...
public:
    ...
    graph_analysis::BaseGraph::Ptr stp();

    // Upper-Lower-Tightening Algorithm
    /*graph_analysis::BaseGraph::Ptr*/ void upperLowerTightening();

    // the intersection between two relations
    graph_analysis::BaseGraph::Ptr intersection(TemporalConstraintNetwork tcn);
