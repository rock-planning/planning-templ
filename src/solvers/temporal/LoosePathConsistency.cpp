...
const std::vector<Bounds> LoosePathConsistency::intersection(std::vector<Bounds> a, std::vector<Bounds> b)
{
...
const std::vector<Bounds> LoosePathConsistency::composition(std::vector<Bounds> a,std::vector<Bounds> b)
{
	std::vector<Bounds> result;
	std::vector<Bounds>::iterator ita = a.begin();
	while (ita!=a.end())
...
const std::vector<Bounds> LoosePathConsistency::looseIntersection(std::vector<Bounds> a, std::vector<Bounds> b)
{
	std::vector<Bounds> result;
	std::vector<Bounds>::iterator ita = a.begin();
	while (ita!=a.end())
...
// [a,b] becomes [-b,-a]
const std::vector<Bounds> LoosePathConsistency::reverseIntervals(std::vector<Bounds> v)
{
	std::vector<Bounds> result;
